...
function say(text,tone){commsEl.textContent=text;commsEl.classList.remove("st-comms-good","st-comms-bad");if(tone==="good"){commsEl.classList.add("st-comms-good-2e7ac99e");}
if(tone==="bad"){commsEl.classList.add("st-comms-bad-2e7ac99e");}}
...
function logFlight(value,won){var li=document.createElement("li");li.className="st-log-entry-2e7ac99e"+
